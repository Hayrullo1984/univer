...
--
-- Host: localhost
-- Generation Time: Jul 27, 2020 at 12:18 PM
...
('admin', 1, 'Bu admin aka', NULL, NULL, 1595756846, 1595756846),
('author', 1, NULL, NULL, NULL, 1595756846, 1595756846),
('updateRmShtat', 2, 'Reja moliyaga o\'zgartirish kirita oladi', NULL, NULL, 1595756846, 1595756846);
...
('m140506_102106_rbac_init', 1595693616),
('m170907_052038_rbac_add_index_on_auth_assignment_user_id', 1595693616),
('m180523_151638_rbac_updates_indexes_without_prefix', 1595693616),
('m200409_110543_rbac_update_mssql_trigger', 1595693617);
...
(8, 1, 1, 2, 1, 1, 1, 10.00, 6, 1, 20000.00, '', 2020, 1, 1, NULL);
...
(1, 'Abduqodir', 'FGsLi9qP8qyNyZ7wEYSPOQwBldR-AzfB', '$2y$13$ew6SsbHv.sz3FvSw5jMNAeQKjPN9TfKir3rkJ1tlAvWq0qYcqvN2e', NULL, 'Abduqodircoder@gmail.com', 10, 1592202891, 1595762981),
(2, 'Test', '3G7f-DEMV3MYNTRGRKR6zMxCP2IbAdBL', '$2y$13$SeU9YBtdBfUiwCZM6kiRPObT8i1Ie/C3a6T4VqcVticKZ9wlUH/8O', NULL, 'test@mail.ru', 10, 1595764623, 1595764623);
...
--
-- Table structure for table `us_permissions`
--
...
--
-- Dumping data for table `us_permissions`
--

INSERT INTO `us_permissions` (`id`, `action_name`, `description`) VALUES
(1, 'createRmShtat', 'Reja moliyaga ma\'lumot qo\'shish'),
(2, 'viewRmShtat', 'Reja moliyadagi ma\'lumotni ko\'ra oladi'),
(3, 'updateRmShtat', 'Reja moliyaga o\'zgartirish kirita oladi'),
(4, 'deleteRmShtat', 'Reja moliyadan ma\'lumotni o\'chira oladi'),
(5, 'createMainmenu', 'Menu yarata oladi'),
(6, 'updateMainmenu', 'Menu ni o\'zgartira oladi'),
(7, 'viewMainmenu', 'Menu ni ko\'ra oladi'),
(8, 'deleteMainmenu', 'Menu ni o\'chira oladi'),
(9, 'createUsBulim', 'Bo\'lim qo\'sha oladi'),
(10, 'updateUsBulim', 'Bo\'limga o\'zgartirish kirita oladi'),
(11, 'deleteUsBulim', 'Bo\'limni o\'chira oladi'),
(12, 'viewUsBulim', 'Bo\'limdagi ma\'lumotlarni ko\'ra oladi'),
(13, 'createUsIImdaraja', 'Ilmiy daraja qo\'sha oladi'),
(14, 'updateUsIlmdaraja', 'Ilmiy darajaga o\'zgartirish kirita oladi'),
(15, 'deleteUsIlmdaraja', 'Ilm darajani o\'chira oladi'),
(16, 'viewUsIlmdaraja', 'Ilm darajani ko\'ra oladi'),
(17, 'createUsIlmunvon', 'Ilm unvonga qo\'sha oladi'),
(18, 'updateUsIlmUnvon', 'Ilm unvonlarga o\'zgartirish kirita oladi'),
(19, 'deleteUsIlmUnvon', 'Ilmmiy unvonni o\'chira oladi'),
(20, 'viewUsIlmUnvon', 'Ilmiy unvonni ko\'ra oladi'),
(21, 'createLavozim', 'Lavozim qo\'sha oladi'),
(22, 'updateLavozim', 'Lavozimni o\'zgartira oladi'),
(23, 'deleteLavozim', 'Lavozimni o\'chira oladi'),
(24, 'viewLavozim', 'Lavozimni ko\'ra oladi'),
(25, 'createUsOylikosh', 'Oylik oshishiga qo\'sha oladi'),
(26, 'updateUsOylikosh', 'Oylik oshishini o\'zgartira oladi'),
(27, 'deleteUsOylikosh', 'Oylik oshishini o\'chira oladi'),
(28, 'viewUsOylikosh', 'Oylik oshishini ko\'ra oladi'),
(29, 'createUsRazryad', 'Razryadga qo\'sha oladi'),
(30, 'updateUsRazryad', 'Razryadni o\'zgartira oladi'),
(31, 'deleteUsRazryad', 'Razryadni o\'chira oladi'),
(32, 'viewUsRazryad', 'Razryadni ko\'ra oladi'),
(33, 'createUsUstama', 'Ustama qo\'sha oladi'),
(34, 'updateUsUstama', 'Ustamaga o\'zgartirish kiritia oladi'),
(35, 'deleteUsUstama', 'Ustamani o\'chira oladi'),
(36, 'viewUsUstama', 'Ustamani ko\'ra oladi'),
(37, 'updateUser', 'User ga o\'zgartirish kirita oladi'),
(38, 'deleteUser', 'Userni o\'chira oladi'),
(39, 'viewUser', 'Userni ko\'ra oladi'),
(40, 'createUsPermission', 'Ruxsatlar yarata oladi'),
(41, 'updateUsPermission', 'Ruxsatlarni o\'zgartira oladi'),
(42, 'deleteUsPermission', 'Ruxsatlarni o\'chira oladi'),
(43, 'viewUsPermission', 'Ruxsatlarni ko\'ra oladi');
...
--
-- Indexes for table `us_permissions`
--
ALTER TABLE `us_permissions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `us_permissions`
--
ALTER TABLE `us_permissions`
